...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.asyncAfter(deadline: DispatchTime.now()+0.1) {
            do{try AVAudioSession.sharedInstance().setMode(AVAudioSession.Mode.default)}
    ...
    func setupButtonNames() {
        resetButton.setTitle("", for: UIControl.State.disabled)
        mainButton.setTitle("", for: UIControl.State.disabled)
        loopButton.setTitle("", for: UIControl.State.disabled)
    }
